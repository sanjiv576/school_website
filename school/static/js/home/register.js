...
const validateInputs = () => {
    ...
    // } else if (password2Val !== passwordValue) {
    ...
    if(firstNameVal !== '' && lastNameVal !== '' && password2Val === passwordVal && passwordVal !== '' && password2Val !== '' && password2Val.length >= 6 && contactVal !== '' && roleVal !==''){
